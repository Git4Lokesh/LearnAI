...
import { WorkflowContext, WorkflowEvent, Workflow, Handler, WorkflowEventData } from '@llamaindex/workflow-core';
...
declare class AgentWorkflow implements Workflow {
    ...
    }): _llamaindex_workflow_core.WorkflowStream<WorkflowEventData<any, string>>;
