...
app.post('/diagnostic/start', ensureAuthenticated, async (req, res) => {
    try {
        if (req.user.diagnostic_completed) return res.redirect('/');
...
app.post('/diagnostic/answer', ensureAuthenticated, async (req, res) => {
    try {
        if (req.user.diagnostic_completed) return res.redirect('/');
...
app.get('/diagnostic/results', ensureAuthenticated, async (req, res) => {
...
app.get('/diagnostic/skip', ensureAuthenticated, async (req, res) => {
